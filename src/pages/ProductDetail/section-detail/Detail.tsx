          ...
          <div className={classes.mainContent}>
            ...
            <div className={classes.cardData}>
              ...
              <div className={classes.date}>
                <span>Дата подачи: 16:07:04 07.12.2018</span>
                <span>Дата обновления: 09:50:24 17.09.2020</span>
              </div>
              ...
              <div className={classes.description}>
                ...
                Минск-Арена, Виктория Олимп отель. Также недалеко находятся
                Аквапарк Лебяжий, Dreamland Park , Парк Победы, Стелла! До ЖД
                вокзала 15 минут езды на автобусе. Будем рады Вас видеть у нас в
                гостях, расскажу,что можно в нашем городе посмотреть, а также
                могу заранее забронировать экскурсии! Все отчетные документы ,
                временная регистрация предоставляется. В квартире Не курят.
                <Button className={classes.readFull}>Читать все</Button>
              </div>
