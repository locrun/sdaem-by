          ...
          <div className={classes.text}>
            ...
            <ul className={classes.list}>
              <li className={classes.item}>
                доступны все функции платного размещения;
              </li>
              <li className={classes.item}>
                объявления тарифа Top закрепляются на 1-ой позиции и не
                участвует в ротации (остаются на занятом месте). Следующее
                объявление занимает 2-ое место и т.д.
              </li>
            </ul>
          </div>
