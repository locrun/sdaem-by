        ...
        <div className={classes.content}>
          ...
          <div className={classes.flex}>
            ...
            <p className={classes.text}>
              ...
              <strong> личный кабинет</strong> , в котором возможно{" "}
              <strong> бесплатно создавать и публиковать </strong> объявления на
              сайте. Таким образом, через несколько минут Вы можете начать
              привлечение клиентов!
            </p>
            <Button className={classes.btn}>+ Разместить объявление</Button>
          </div>
        </div>
      </div>
    </section>
