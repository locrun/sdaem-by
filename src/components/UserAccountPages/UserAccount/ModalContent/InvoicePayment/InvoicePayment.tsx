...
const data = [
  {
    id: 0,
    apartment: "4-комн. апартаменты на Грушевке",
    address: "Минск, б-р Мулявина, д. 10",
  },
  {
    id: 1,
    apartment: "4-комн. апартаменты на Грушевке длинное название объекта",
    address: "Минск, б-р Мулявина, д. 10",
  },
  {
    id: 2,
      ...
      <div>
        ...
        <div className={classes.pay}>
          ...
          <div className={classes.buttons}>
            <Button className={classes.cancelBtn} onClick={onClickHandler}>
              Отменить
            </Button>
            <Button className={classes.createBtn} onClick={onHandleClick}>
              Создать счет
            </Button>
          </div>
        </div>
